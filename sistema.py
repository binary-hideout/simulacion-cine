...
# root = tk.Tk()
# hello_message = tk.Label(root, text="Hello World!")
# hello_message.pack()
# root.mainloop()
...
class Sistema:
    ...
    def inicializar(self):
        ...
        # Salida clientes
        self.clientes_total = tk.Label(self.frame, text="Clientes atendidos")
    ...
    def correr_simulacion(self):
        ...
        to, na, tna = simular(tiempo_limite, cantidad_clientes)
        
        self.tiempo_ocio_total = float(to[0]) + float(to[1]) + float(to[2])
        print(float(to[0]))
        print(float(to[1]))
        print(float(to[2]))
        ...
        self.salida_clientes.set(str(tna) + " clientes")
        self.salida_tiempos.set(self.tiempo_ocio_total)
